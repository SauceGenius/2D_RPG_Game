...
public class Animation {
    ...
    public Animation(String name, int nbFrames, int speed, SpriteSet spriteSet){
        BufferedImage bufferedImage = (BufferedImage) spriteSet.get(name);

        //this.img1 = bufferedImage.getSubimage();
        /*if(nbFrames >= 2){this.img2 = bufferedImage.getSubimage(
                index * Game.SPRITE_SIZE_PLAYER,
